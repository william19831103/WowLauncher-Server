...
)
{
    ...
    ::RegisterClassExW(&wc);
    // 修改这行，使用正常的窗口样式而不是 WS_POPUP
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"魔兽世界服务端", 
        WS_OVERLAPPEDWINDOW,    // 使用标准窗口样式
        CW_USEDEFAULT, CW_USEDEFAULT, // 让系统决定窗口位置
        1280, 960,              // 设置窗口大小
    ...
    // io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable;   // 注释掉或删除这行
    
    ImGui::StyleColorsLight();
    ImGuiStyle& style = ImGui::GetStyle();
    if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)  // 这个if块也可以删除
    {
